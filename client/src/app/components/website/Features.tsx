...
const Features = () => {
    return (
        <div className='w-full h-auto max-w-screen-2xl mx-auto relative overflow-hidden p-4 mt-4'>
            ...
            <section className="w-full h-auto lg:h-[300px] grid grid-cols-12 gap-6 mt-8">
                {/* Left Feature */}
                <div className="col-span-12 lg:col-span-5 bg-primary-web/10 p-6 rounded-2xl relative">
                ...
                {/* Right Feature */}
                <div className="col-span-12 lg:col-span-7  bg-primary-web/10 p-6 rounded-2xl relative overflow-hidden">
                    <div className="flex flex-col justify-start lg:justify-between h-auto lg:h-full">
                        <h2 className="text-xl lg:text-3xl font-normal text-black">
                            Your idle funds
            ...
            <section className="w-full h-auto lg:h-[300px] grid grid-cols-12 gap-6 mt-8">
                ...
                {/* Right Feature */}
                <div className="col-span-12 lg:col-span-5 bg-primary-web/10 p-6 rounded-2xl relative overflow-hidden">
                    <div className="flex flex-col justify-start lg:justify-between h-auto lg:h-full">
                        <h2 className="text-xl lg:text-3xl font-normal text-black">
